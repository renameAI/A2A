...
- **설득 구조는 예시로 배운다.** body는 `paragraphs` 배열의 원소 하나씩
  ...
  이 예시에서 **가져갈 것**:
  ① 그 언어의 관용 인사 + 수신 회사명으로 연다(실측: 영어 64/64, 프랑스어
     50/52, 인니어 46/46). 맺음 인사로 닫는다. 우리 실측 출력에는 둘 다 없었다.
  ② 상대를 구체적으로 짚는다 — 이 회사에만 해당하는 사실로. 어느 회사에나
     붙는 칭찬은 그 문장 하나로 대량 발송임이 드러난다.
  ③ 우리가 누구인지 한 문장 — 상대가 우리를 모르므로, 상호만 던지지 말고
     "무엇을 하는 어디 회사"인지 동격으로 붙인다.
  ④ **상대의 목표를 주어로** 과제를 세운다. "우리 제품이 도움이 될 수
     ...
     온다.
  ⑤ 관측에서 제안으로 **바로 넘어가지 않는다** — 사이에 상대의 것과 우리의
     것을 잇는 한 단락이 있다(영어 64/64, 프랑스어 54/63). 관측 뒤에 소개를
     바로 붙이면 관측이 판매의 미끼로 읽힌다. 형식은 자유다(가정형 질문은
     이 예시의 방식일 뿐이다).
  ⑥ 제안은 상대가 얻는 것으로 쓴다. 그리고 부담 낮은 다음 행동 하나로 닫는다.
