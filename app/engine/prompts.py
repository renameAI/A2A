...
고유명사를 짧게 직접 인용한다 (예: (자료: "PoC 3건 진행")). 3문장째(역추론이 있으면) = \
「추정:」으로 시작하고, 그 추정이 틀렸다면 드러날 반증 신호 1개를 함께 쓴다.
- 자료에 수치(고객 수·계약·연도·금액)가 있으면 형용사 대신 수치를 쓴다. \
✗ "빠르게 성장 중" → ✓ "1년 내 유료 고객 3곳→11곳".
